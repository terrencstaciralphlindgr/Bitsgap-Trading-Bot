...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(781, 610)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(781, 610))
        MainWindow.setMaximumSize(QtCore.QSize(781, 610))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 291, 571))
        self.groupBox.setObjectName("groupBox")
        self.mt_table = QtWidgets.QTableWidget(self.groupBox)
        self.mt_table.setGeometry(QtCore.QRect(10, 20, 271, 391))
        ...
        self.label.setGeometry(QtCore.QRect(80, 480, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.mt_collective = QtWidgets.QLabel(self.groupBox)
        self.mt_collective.setGeometry(QtCore.QRect(180, 480, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.mt_collective.setFont(font)
        self.mt_collective.setObjectName("mt_collective")
        self.mt_createchart = QtWidgets.QPushButton(self.groupBox)
        self.mt_createchart.setGeometry(QtCore.QRect(10, 510, 271, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.mt_createchart.setFont(font)
        self.mt_createchart.setObjectName("mt_createchart")
        self.groupBox_3 = QtWidgets.QGroupBox(self.groupBox)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 430, 131, 41))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(160, 430, 121, 41))
        self.groupBox_4.setFlat(True)
        self.groupBox_4.setObjectName("groupBox_4")
        self.mt_stoploss = QtWidgets.QLineEdit(self.groupBox_4)
        self.mt_stoploss.setGeometry(QtCore.QRect(0, 20, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(False)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(320, 10, 451, 571))
        self.groupBox_2.setObjectName("groupBox_2")
        self.st_table = QtWidgets.QTableWidget(self.groupBox_2)
        self.st_table.setGeometry(QtCore.QRect(10, 20, 431, 541))
        ...
        self.st_table.setColumnCount(5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mt_createchart.setText(_translate("MainWindow", "View Chart"))

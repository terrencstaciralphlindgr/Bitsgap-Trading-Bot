...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.auto_restart_table = QtWidgets.QTableWidget(self.tab)
        self.auto_restart_table.setGeometry(QtCore.QRect(10, 10, 841, 681))
        self.auto_restart_table.setRowCount(100)
        self.auto_restart_table.setObjectName("auto_restart_table")
        self.auto_restart_table.setColumnCount(8)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.auto_restart_table.setHorizontalHeaderItem(7, item)
        self.auto_restart_table.horizontalHeader().setDefaultSectionSize(99)
        self.auto_restart_table.horizontalHeader().setStretchLastSection(False)
        self.auto_restart_table.verticalHeader().setDefaultSectionSize(25)
        self.auto_restart_table.verticalHeader().setMinimumSectionSize(25)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.auto_restart_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Selected for auto start"))
        item = self.auto_restart_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "PAIRS"))
        item = self.auto_restart_table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Grid Levels"))
        item = self.auto_restart_table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Current Price"))
        item = self.auto_restart_table.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Current Price to high price"))
        item = self.auto_restart_table.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Grid Size %"))
        item = self.auto_restart_table.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "High Price"))
        item = self.auto_restart_table.horizontalHeaderItem(7)
